...
(() => {
  const partners = [
    ...
    ['GENERALI', 'mpi.png?v=20260920-2135', 'MPI Generali insurance logo', 'generali'],
  ...
  const css = `
    .insurance-panel-grid{max-width:1180px!important;margin:0 auto!important;display:flex!important;flex-wrap:wrap!important;justify-content:center!important;gap:18px!important;background:transparent!important}
    .insurance-panel-card{flex:0 0 calc((100% - 72px)/5)!important;min-width:0!important;min-height:118px!important;padding:14px 16px!important;background:#0b0b0b!important;border:1px solid #303030!important;border-radius:6px!important;display:flex!important;align-items:center!important;justify-content:center!important;position:relative!important;overflow:hidden!important;box-shadow:none!important;transform:none!important}
    ...
    .insurance-panel-card .insurance-logo-aia{max-width:170px!important}.insurance-panel-card .insurance-logo-axa{max-width:170px!important}.insurance-panel-card .insurance-logo-chubb{max-width:210px!important}.insurance-panel-card .insurance-logo-liberty{max-width:210px!important}.insurance-panel-card .insurance-logo-lonpac{max-width:180px!important}.insurance-panel-card .insurance-logo-msig{max-width:205px!important}.insurance-panel-card .insurance-logo-pno{max-width:190px!important}.insurance-panel-card .insurance-logo-progressive{max-width:205px!important}.insurance-panel-card .insurance-logo-generali{max-width:340px!important;height:112px!important}.insurance-panel-card .insurance-logo-rhb{max-width:185px!important}.insurance-panel-card .insurance-logo-ikhlas{max-width:175px!important}.insurance-panel-card .insurance-logo-pacific{max-width:205px!important}.insurance-panel-card .insurance-logo-tokio{max-width:210px!important}.insurance-panel-card .insurance-logo-zurich{max-width:195px!important}.insurance-panel-card .insurance-logo-kurnia{max-width:205px!important}.insurance-panel-card .insurance-logo-aig{max-width:210px!important}.insurance-panel-card .insurance-logo-malaysia{max-width:190px!important}.insurance-logo-tune{max-width:190px!important}
    ...
    @media(max-width:700px){.insurance-panel-grid{gap:9px!important}.insurance-panel-card{flex-basis:calc((100% - 9px)/2)!important;min-height:118px!important;padding:12px 9px!important}.insurance-panel-card .insurance-logo{max-width:170px!important;height:72px!important}.insurance-panel-card .insurance-logo-generali{max-width:280px!important;height:96px!important}}
    @media(max-width:420px){.insurance-panel-card{min-height:108px!important}.insurance-panel-card .insurance-logo{max-width:150px!important;height:65px!important}.insurance-panel-card .insurance-logo-generali{max-width:250px!important;height:88px!important}}
  `;
