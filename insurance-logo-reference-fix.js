...
(() => {
  ...
  const css = `
    ...
    @media(max-width:700px){.insurance-panel-grid{gap:9px!important}.insurance-panel-card{flex-basis:calc((100% - 9px)/2)!important;min-height:118px!important;padding:12px 9px!important}.insurance-panel-card .insurance-logo{max-width:170px!important;height:72px!important}.insurance-panel-card .insurance-logo-generali{max-width:205px!important;height:82px!important}}
    @media(max-width:420px){.insurance-panel-card{min-height:108px!important}.insurance-panel-card .insurance-logo{max-width:150px!important;height:65px!important}.insurance-panel-card .insurance-logo-generali{max-width:185px!important;height:76px!important}}
  `;
